		...
		<div class="content-left">
			<div class="content-left-top-brands">
				...
				<ul>
					...
					<li><a href="<?php echo U('Stu/index');?>">基本信息</a></li>
					<li><a href="<?php echo U('Stu/stufile');?>">资料管理</a></li>
					<li><a href="<?php echo U('Stu/followlist');?>" style="color: #E45D5D;">我的收藏</a></li>
		...
		<div class="content-right product-box">
			...
			<div class="product-grids">
				...
				<table class="table table-condensed ">
					...
					<tbody>
						<?php if(is_array($listM)): $i = 0; $__LIST__ = $listM;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
								<th scope="row">

									<a href="<?php echo U('Detail/detail_good',array('id'=>$data['good_id']));?>">

										<?php  $m=M('goods'); $con['id']=$data['good_id']; $listM=$m->where($con)->limit(10)->find(); echo($listM['title']); ?>
								...
								<td>
									...
									<a href="<?php echo U('Stu/followdel',array('id'=>$data['id']));?>">取消</a>
