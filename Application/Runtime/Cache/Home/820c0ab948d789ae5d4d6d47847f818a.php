	...
	<div class="wrap">
		<div class="content-left">
			<div class="content-left-top-brands">
				<h3>商品列表</h3>
				<ul>					
					<li><a href="<?php echo U('Com/index');?>" >基本信息</a></li>
					<li><a href="<?php echo U('Com/profile');?>" >店铺管理</a></li>
					<li><a href="<?php echo U('Publish/index');?>">发布商品</a></li>
					<li><a href="<?php echo U('Pro/admin');?>"style="color: #E45D5D;">管理商品</a></li>
					<li><a href="<?php echo U('Com/znxlist');?>">站内信</a></li>					
				</ul>
			</div>	
		</div>
				...
				<table class="table table-condensed ">
					...
					<tbody>
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
									...
									<td>
										<a href="<?php echo U('Detail/detail_good',array('id'=>$data['id']));?>"><?php echo ($data["title"]); ?></a>

									</td>
									<td>

										<a href="<?php echo U('Detail/detail_good',array('id'=>$data['id']));?>">查看</a>|

										<a href="<?php echo U('Pro/delete',array('id'=>$data['id']));?>">删除</a>|
										<a href="<?php echo U('Pro/edit',array('id'=>$data['id']));?>">编辑</a>
