		...
		<div class="content-left">
			<div class="content-left-top-brands">
				...
				<ul>
					...
					<li><a href="<?php echo U('Com/index');?>" style="color: #E45D5D;">基本信息</a></li>
					<li><a href="<?php echo U('Com/profile');?>">店铺管理</a></li>
					<li><a href="<?php echo U('Publish/index');?>">发布商品</a></li>
					<li><a href="<?php echo U('Pro/admin');?>">管理商品</a></li>
		...
		<div class="content-right product-box">
			...
			<div class="product-grids">
				...
				<div class="login-left">
					<h3>店铺名称：<?php echo ($mau["mall_name"]); ?></h3>
					<p>店铺简介：<?php echo ($mau["info"]); ?></p>
					<p>联系地址：<?php echo ($mau["address"]); ?></p>
					<p>联系人：<?php echo ($mau["contact_name"]); ?></p>
					<p>联系电话：<?php echo ($muser["mobile"]); ?></p>
					<p>支付宝账号：<?php echo ($muser["zfb"]); ?></p>
					<p>首次登录请编辑完善个人信息！</p>
					<a href="<?php echo U('Com/profile');?>" class="acount-btn">编辑</a>
				</div>
