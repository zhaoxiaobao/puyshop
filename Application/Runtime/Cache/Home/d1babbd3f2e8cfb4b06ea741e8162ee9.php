		...
		<div class="content-left">
			<div class="content-left-top-brands">
				...
				<ul>
					...
					<li><a href="<?php echo U('Com/znxlist');?>" style="color: #E45D5D;">站内信</a></li>
				</ul>
			</div>	
		</div>
					...
					<tbody>
						<?php if(is_array($Info)): $i = 0; $__LIST__ = $Info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
								<th scope="row">
									...
									<?php  echo(getname($data['send_id'])); ?></th>
									<td><?php echo ($data["msg_text"]); ?></td>
									<td>
										<?php if(($data['status'] == 0)): ?>未读
											<?php else: ?>
											已读<?php endif; ?>
								...
								<td>
									...
									<a href="<?php echo U('Msg/msgred',array('id'=>$data['id']));?>">设为已读</a>|
									<a href="<?php echo U('Msg/reply',array('id'=>$data['send_id']));?>">回复</a>|<a href="<?php echo U('Msg/msgdel',array('id'=>$data['id']));?>">删除</a></td>
