...
<form id="form-fb" role="form" method="post" action="<?php echo U('Pro/do_edit');?>" enctype="multipart/form-data" >
                  ...
                  <img class="etalage_source_image" src="<?php echo ($data["url"]); ?>" />
                            ...
                            <div class="details-left-info">
                              <div class="details-right-head">
                               <h1>商品标题<input type="text"name="title" value="<?php echo ($Info["title"]); ?>" ></h1>
                               ...
                               <h1>商品价格<input name="price" type="text" class="form-control" value="<?php echo ($Info["m_price"]); ?>" >
                               </h1>
                              ...
                              <h1>商品库存
                                <input name="kucun" type="text" class="form-control ml-20" value="<?php echo ($Info["count"]); ?>" >
                              </h1>

                              
                              <h1>商品关键字
                                <input name="keywords" type="text" class="form-control" value="<?php echo ($Info["keywords"]); ?>" >
                              </h1>
                ...
                serverUrl :'<?php echo U('Home/Web/ueditor');?>'
                         ...
                         <script type="text/javascript">
                          ...
                          function setContent(isAppendTo) {
                            UE.getEditor('editor').setContent('<?php echo ($des); ?>', isAppendTo);
                          }
